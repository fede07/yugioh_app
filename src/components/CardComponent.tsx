    ...
    >
      ...
      {isPendulum ? (
        ...
        <>
          ...
          <div
            className={`flex flex-col justify-between p-1 border-2 rounded-sm overflow-hidden text-xs ${borderDesc} ${descBg} h-[90px] mt-2 text-black`}
          >
            {isSpellOrTrap ? (
